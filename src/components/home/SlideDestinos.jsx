...
class SlideDestinos extends React.Component {
    render() {
        return (
            ...
            >
                <SwiperSlide><img  loading="lazy" src={Img1} alt=""/></SwiperSlide>
                <SwiperSlide><img  loading="lazy" src={img2} alt=""/></SwiperSlide>
                <SwiperSlide><img loading="lazy" src={img3} alt=""/></SwiperSlide>
                <SwiperSlide><img loading="lazy" src={img4} alt=""/></SwiperSlide>
                <SwiperSlide><img loading="lazy" src={img4} alt=""/></SwiperSlide>
                <SwiperSlide><img loading="lazy" src={img4} alt=""/></SwiperSlide>
                <SwiperSlide><img loading="lazy" src={img4} alt=""/></SwiperSlide>
                <br></br>
